...
const products: catalog = {
        "keyboards": [
            {   
                ...
                inthebox: [{count: 1, content: 'Keyboard'}, {count: 1, content: 'KIIBS Carrying Case'}, {count: 1, content: 'Model X Keycaps'}, {count: 1, content: 'USB Type-C Cable'}],
                price: 599
            },
            {   
                id: 1,
...
export function getSelection(productCategory: string, productId: number): product[]{
    let items: product[] = []
...
// export default { getProductsOfType, getProduct, getCount,}